...
sArgParser.add_argument('-cat', metavar="<category>", help='Choose from 1 or more categories (cloud, code, edu, comm, docs, forms, other), use , as delimiter. Defaults to all categories.')
