# About sitedorks
Search Google, Bing, Yahoo or Yandex for a search term with different websites. A default list is already provided, which contains Github, Gitlab, Surveymonkey, Trello etc etc. Currently, a default list of 187 dorkable websites is available.
...
Current categories on file are: analysis(8), cloud(27), code(30), comm(18), companies(8), docs(23), edu(2),
