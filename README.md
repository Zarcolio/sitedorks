...
Search Google, Bing, Brave, Ecosia, Yahoo or Yandex for a search term with several websites. A [default list](https://github.com/Zarcolio/sitedorks/blob/master/csv/WorldWide.csv) is already provided, which contains Moltbook, Grok, Github, Gitlab, Surveymonkey, Trello etc etc. Currently, a default list of 624 dorkable websites is available.
